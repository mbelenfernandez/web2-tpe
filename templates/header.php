    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="">Letras de Canciones</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="cancion">Cancion 1</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="abmGenero">ABM género</a>
                        </li> 
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="abmCancion">ABM canción</a>
                        </li>                         
                        <li class="nav-item">
